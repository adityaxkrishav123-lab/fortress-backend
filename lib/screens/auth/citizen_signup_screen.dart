...
class _CitizenSignupScreenState extends State<CitizenSignupScreen> {
  ...
  // Placeholder list from backend logic
  ...
  Future<void> _onSubmit() async {
    ...
    try {
      // 1. Generate a dummy UID for the demo flow (In production, this comes from Firebase Auth)
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Citizen Identification'),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text('Signup as Citizen', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: AppTheme.primaryColor)),
            ...
            const SizedBox(height: 16),
            _buildTextField('Address', _addressController, Icons.home_outlined, maxLines: 3),
            const SizedBox(height: 16),
